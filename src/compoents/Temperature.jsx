...
export default function Temperature({setCity,stats}) {
  ...
  useEffect(() => {
    const placeholderTexts = ["London","Enter city", "New York",];
    let index = 0;
    ...
    <>
      ...
      <div className="flex justify-center mt-6">
        ...
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-14 h-12 text-white text-transform scale-100 hover:scale-110 transition-transform duraiton-300 ease-in-out"
        >
          <path
            strokeLinejoin="round"
      ...
      <div className="flex justify-center mt-8 text-white text-3xl">
        <p className="font-semibold text-[55px] text-transform scale-100 hover:scale-110 transition-transform duraiton-300 ease-in-out">{stats.temp}</p>
